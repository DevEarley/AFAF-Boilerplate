...
public class SliderService : MonoBehaviour
{
	...
	public SliderBehaviour CreateSliderButtons(float minValue, float maxValue, float currentValue, string SliderName)
	{
		...
		leftButtonBehaviour.OnRegistered("-",0,SliderParentBehaviour.OnLeftSliderButtonDown, SliderParentBehaviour.OnLeftSliderButtonHover);
		...
		rightButtonBehaviour.OnRegistered("+",1,SliderParentBehaviour.OnRightSliderButtonDown, SliderParentBehaviour.OnRightSliderButtonHover);
		...
		doneButtonBehaviour.OnRegistered("DONE",2,SliderParentBehaviour.OnDoneButtonDown, SliderParentBehaviour.OnDoneButtonHover);
